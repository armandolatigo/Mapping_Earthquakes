...
console.log("Coding is Hard, but we'll achieve it");

// Create the map object with a center and zoom level.
let map = L.map("mapid").setView([37.6213, -122.3790],2);
...
// pointToLayer function with .bindPopup
...
L.geoJSON(sanFranAirport, {
    ...
    onEachFeature: function(feature, layer) {
        console.log(layer);
        layer.bindPopup("<h2>" + "Airport Code: " + feature.properties.faa + "</h2><h3>" + feature.properties.name + "</h3>");
    }
}).addTo(map);
